...
set SCRIPT_PATH="C:/Users/ahmed/Documents/vvreconstruction/python/synthetic_data_gen/src/offline_generation.py"
...
@REM call %PYTHON_ENV_ISAAC% %SCRIPT_PATH% --input */parameters/narvis_gen.yaml --output */dataset/narvis --mount %WORKSPACE_PATH% --overwrite --headless

call %PYTHON_ENV_ISAAC% %SCRIPT_PATH%